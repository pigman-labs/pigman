---
source_file: "training/loops/train_joint_world_model.py"
type: "code"
...
# train_joint_world_model.py

## Connections
- [[JointWorldModelReport]] - `contains` [EXTRACTED]
- [[train_joint_world_model()]] - `contains` [EXTRACTED]
